...
export default function PlannerPage() {
    ...
    return (
        <main className="min-h-screen bg-off-white pt-24 pb-12 px-6">
                ...
                <aside className="lg:w-80 xl:w-96 flex-shrink-0">
                    <div className="sticky top-24">
                        <div className="bg-tech-black text-off-white p-6 border-l-4 border-signal-red shadow-xl">
                            ...
                            <div className="mb-8 space-y-2 max-h-60 overflow-y-auto pr-2 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/20">
                                <AnimatePresence>
...
const PlannerForm = ({ selectedFeatures }: { selectedFeatures: Set<string> }) => {
    ...
    if (state.success) {
        return (
            ...
            >
                <Typography variant="h4" className="text-green-400 mb-2">Blueprint Received</Typography>
